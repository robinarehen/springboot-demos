...
* El entregable debe compilar en una instalación de maven totalmente limpia, debe indicarse en un fichero README tanto los pasos necesarios 
	* para generar el jar final como para ejecutarlo (no hace falta mucho detalle).
